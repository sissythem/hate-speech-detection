...
if __name__ == '__main__':
    ...
    result_file = join(data["path_to_instances"], data["dataset_folder"], data["feature_folder"], "Result_avg_Neural_Networks.txt")
    macro_precision, micro_precision, macro_recall, micro_recall, macro_f, micro_f = numpy.mean(results, axis=0)
